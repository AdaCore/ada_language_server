...
However we recommend configuring the main project file explicitly, via the [Ada: Open Project...](command:ada.openProjectFile) command. This will set the `ada.projectFile` setting for you and reload the project.
You can also edit the [ada.projectFile](command:toSide:workbench.action.openWorkspaceSettings?%22ada.projectFile%22) workspace setting manually as an alternative.
