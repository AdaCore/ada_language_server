 ...
 */
export type ReplaceTypeCommandArgs = {
    newType: string;
};
...
export const alsReplaceTypeCommandExecutor = async (
    ...
    const prompt = 'Insert the name of the new type';

    const rules = [AdaGrammarRule.Defining_Name_Rule];

    const diagnostic = 'This is not a syntactically valid type name';
