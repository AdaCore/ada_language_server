...
vscode_only="trace.server showNotificationsOnErrors enableExperimentalFeatures projectView.flatMode projectView.showObjectDirectories projectView.showRuntimeFiles externalAnnotations.showInEditor"
