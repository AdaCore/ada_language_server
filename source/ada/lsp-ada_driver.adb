...
with LSP.Ada_Handlers.Scenario_Variables_Commands;
...
procedure LSP.Ada_Driver is
   ...
   begin
      ...
      LSP.Ada_Commands.Register
        (LSP.Ada_Handlers.Scenario_Variables_Commands.Command'Tag);
      LSP.Ada_Commands.Register
      ...
      LSP.Ada_Commands.Register
        (LSP.Ada_Handlers.Refactor.Generate_Package.Command'Tag);
      LSP.Ada_Commands.Register
