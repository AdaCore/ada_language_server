...
package LSP.Predefined_Completion.Ada2022 is
   ...
   & """ASPECT"": ["
   & "{"
   & """DOC"": ""This aspect is equivalent to *note pragma Abstract_State: 1e."","
   & """_id"": ""0"","
   ...
   & "},"
   & "{"
   & """DOC"": ""This boolean aspect is equivalent to *note pragma Always_Terminates: 29."","
   & """_id"": ""0"","
   & """_name"": ""Always_Terminates"","
   & """_origin"": ""GNAT RM"","
   & """_category"": ""unknown"""
   & "},"
   & "{"
   ...
   & "},"
   & "{"
   & """DOC"": ""This boolean aspect is equivalent to *note pragma Async_Readers: 32."","
   & """_id"": ""0"","
   & """_name"": ""Async_Readers"","
   & """_origin"": ""GNAT RM"","
   & """_category"": ""unknown"""
   & "},"
   & "{"
   & """DOC"": ""This boolean aspect is equivalent to *note pragma Async_Writers: 34."","
   & """_id"": ""0"","
   & """_name"": ""Async_Writers"","
   & """_origin"": ""GNAT RM"","
   & """_category"": ""unknown"""
   ...
   Db2 : constant String := """_category"": ""unknown"""
   & "},"
   & "{"
   & """DOC"": ""This aspect is equivalent to *note pragma Default_Initial_Condition: 52."","
   & """_id"": ""0"","
   ...
   & "},"
   & "{"
   & """DOC"": ""This aspect is equivalent to *note pragma Depends: 56."","
   & """_id"": ""0"","
   & """_name"": ""Depends"","
   & """_origin"": ""GNAT RM"","
   & """_category"": ""unknown"""
   ...
   & "},"
   & "{"
   & """DOC"": ""This aspect is equivalent to *note pragma Effective_Reads: 5b."","
   & """_id"": ""0"","
   ...
   & "},"
   & "{"
   & """DOC"": ""This aspect is equivalent to *note pragma Effective_Writes: 5d."","
   & """_id"": ""0"","
   ...
   & "},"
   & "{"
   & """DOC"": ""This aspect is equivalent to *note pragma Extensions_Visible: 6d."","
   & """_id"": ""0"","
   ...
   & "},"
   & "{"
   & """DOC"": ""This boolean aspect is equivalent to *note pragma Favor_Top_Level: 72."","
   & """_id"": ""0"","
   ...
   & "},"
   & "{"
   & """DOC"": ""This aspect is equivalent to *note pragma Ghost: 76."","
   & """_id"": ""0"","
   & """_name"": ""Ghost"","
   & """_origin"": ""GNAT RM"","
   & """_category"": ""unknown"""
   ...
   & """_id"": ""0"","
   & """_name"": ""Ghost_Predicate"","
   & """_origin"": ""GNAT RM"","
   & """_category"": ""unknown"""
   & "},"
   & "{"
   & """DOC"": ""This aspect is equivalent to *note pragma Global: 78."","
   & """_id"": ""0"","
   & """_name"": ""Global"","
   & """_origin"": ""GNAT RM"","
   & """_category"": ""unknown"""
   ...
   Db4 : constant String := "{"
   & """DOC"": ""This aspect is equivalent to *note pragma Initial_Condition: 85."","
   & """_id"": ""0"","
   ...
   & "},"
   & "{"
   & """DOC"": ""This aspect is equivalent to *note pragma Initializes: 88."","
   & """_id"": ""0"","
   & """_name"": ""Initializes"","
   & """_origin"": ""GNAT RM"","
   & """_category"": ""unknown"""
   & "},"
   & "{"
   & """DOC"": ""This boolean aspect is equivalent to *note pragma Inline_Always: 8a."","
   & """_id"": ""0"","
   & """_name"": ""Inline_Always"","
   & """_origin"": ""GNAT RM"","
   & """_category"": ""unknown"""
   ...
   & "},"
   & "{"
   & """DOC"": ""This aspect is equivalent to *note pragma Linker_Section: 9a."","
   & """_id"": ""0"","
   ...
   & """_id"": ""0"","
   & """_name"": ""Local_Restrictions"","
   & """_origin"": ""GNAT RM"","
   & """_category"": ""unknown"""
   & "},"
   & "{";

   Db5 : constant String := """DOC"": ""This boolean aspect is equivalent to *note pragma Lock_Free: 9c."","
   & """_id"": ""0"","
   & """_name"": ""Lock_Free"","
   & """_origin"": ""GNAT RM"","
   & """_category"": ""unknown"""
   & "},"
   & "{"
   & """DOC"": ""This aspect is equivalent to *note pragma Max_Queue_Length: a4."","
   & """_id"": ""0"","
   ...
   & "},"
   & "{"
   & """DOC"": ""This boolean aspect is equivalent to *note pragma No_Caching: a7."","
   & """_id"": ""0"","
   & """_name"": ""No_Caching"","
   & """_origin"": ""GNAT RM"","
   & """_category"": ""unknown"""
   ...
   & "},"
   & "{"
   & """DOC"": ""This boolean aspect is equivalent to *note pragma No_Inline: ad."","
   & """_id"": ""0"","
   & """_name"": ""No_Inline"","
   & """_origin"": ""GNAT RM"","
   & """_category"": ""unknown"""
   & "},"
   & "{"
   & """DOC"": ""This boolean aspect is equivalent to *note pragma No_Raise: af."","
   & """_id"": ""0"","
   & """_name"": ""No_Raise"","
   & """_origin"": ""GNAT RM"","
   & """_category"": ""unknown"""
   ...
   Db6 : constant String := """_id"": ""0"","
   & """_name"": ""No_Task_Parts"","
   & """_origin"": ""GNAT RM"","
   & """_category"": ""unknown"""
   & "},"
   & "{"
   & """DOC"": ""This aspect is equivalent to *note attribute Object_Size: 157."","
   & """_id"": ""0"","
   & """_name"": ""Object_Size"","
   & """_origin"": ""GNAT RM"","
   & """_category"": ""unknown"""
   ...
   & "},"
   & "{"
   & """DOC"": ""This aspect is equivalent to *note pragma Part_Of: bc."","
   & """_id"": ""0"","
   & """_name"": ""Part_Of"","
   & """_origin"": ""GNAT RM"","
   & """_category"": ""unknown"""
   & "},"
   & "{"
   & """DOC"": ""This boolean aspect is equivalent to *note pragma Persistent_BSS: c0."","
   & """_id"": ""0"","
   ...
   & "},"
   & "{"
   & """DOC"": ""This boolean aspect is equivalent to *note pragma Program_Exit: d0."","
   & """_id"": ""0"","
   & """_name"": ""Program_Exit"","
   & """_origin"": ""GNAT RM"","
   & """_category"": ""unknown"""
   & "},"
   & "{"
   & """DOC"": ""This boolean aspect is equivalent to *note pragma Pure_Function: d5."","
   & """_id"": ""0"",";

   Db7 : constant String := """_name"": ""Pure_Function"","
   & """_origin"": ""GNAT RM"","
   & """_category"": ""unknown"""
   & "},"
   & "{"
   & """DOC"": ""This aspect is equivalent to *note pragma Refined_Depends: d9."","
   & """_id"": ""0"","
   ...
   & "},"
   & "{"
   & """DOC"": ""This aspect is equivalent to *note pragma Refined_Global: db."","
   & """_id"": ""0"","
   ...
   & "},"
   & "{"
   & """DOC"": ""This aspect is equivalent to *note pragma Refined_Post: dd."","
   & """_id"": ""0"","
   & """_name"": ""Refined_Post"","
   & """_origin"": ""GNAT RM"","
   & """_category"": ""unknown"""
   & "},"
   & "{"
   & """DOC"": ""This aspect is equivalent to *note pragma Refined_State: df."","
   & """_id"": ""0"","
   & """_name"": ""Refined_State"","
   & """_origin"": ""GNAT RM"","
   & """_category"": ""unknown"""
   ...
   & "},"
   & "{"
   & """DOC"": ""This aspect is equivalent to *note pragma Remote_Access_Type: e2."","
   & """_id"": ""0"","
   ...
   Db8 : constant String := """_origin"": ""GNAT RM"","
   & """_category"": ""unknown"""
   & "},"
   & "{"
   ...
   & "},"
   & "{"
   & """DOC"": ""This aspect is equivalent to *note pragma Secondary_Stack_Size: e8."","
   & """_id"": ""0"","
   ...
   & "},"
   & "{"
   & """DOC"": ""This aspect is equivalent to *note pragma Side_Effects: ef."","
   & """_id"": ""0"","
   & """_name"": ""Side_Effects"","
   & """_origin"": ""GNAT RM"","
   & """_category"": ""unknown"""
   & "},"
   & "{"
   & """DOC"": ""This aspect is equivalent to *note attribute Simple_Storage_Pool: f2."","
   & """_id"": ""0"","
   ...
   & "},"
   & "{"
   & """DOC"": ""For the syntax and semantics of this aspect, see the SPARK 2014\nReference Manual, section 6.1.8."","
   & """_id"": ""0"","
   & """_name"": ""Subprogram_Variant"","
   & """_origin"": ""GNAT RM"",";

   Db9 : constant String := """_category"": ""unknown"""
   & "},"
   & "{"
   ...
   & "},"
   & "{"
   & """DOC"": ""This aspect is equivalent to *note pragma Test_Case: 109."","
   & """_id"": ""0"","
   & """_name"": ""Test_Case"","
   & """_origin"": ""GNAT RM"","
   & """_category"": ""unknown"""
   ...
   & "},"
   & "{"
   & """DOC"": ""This boolean aspect is equivalent to *note pragma Unmodified: 118."","
   & """_id"": ""0"","
   & """_name"": ""Unmodified"","
   & """_origin"": ""GNAT RM"","
   & """_category"": ""unknown"""
   ...
   & "},"
   & "{"
   & """DOC"": ""This aspect is equivalent to *note attribute Value_Size: 177."","
   & """_id"": ""0"","
   & """_name"": ""Value_Size"","
   & """_origin"": ""GNAT RM"","
   & """_category"": ""unknown"""
   ...
   Db12 : constant String := """DOC"": ""Default storage pool for a generic instance. See 13.11.3."","
   & """_id"": ""18/3"","
   ...
   & "},"
   & "{"
   & """DOC"": ""Machine address of an entity. See 13.3.\n\n2.1/5 Aggregate Mechanism to define user-defined aggregates. See 4.3.5."","
   & """_id"": ""2/3"","
   & """_name"": ""Address"","
   & """_origin"": ""Ada RM"","
   & """_category"": ""unknown"""
   ...
   Db14 : constant String := """_name"": ""Inline"","
   & """_origin"": ""Ada RM"","
   & """_category"": ""unknown"""
   & "},"
   & "{"
   ...
   Db16 : constant String := """_category"": ""unknown"""
   & "},"
   & "{"
   ...
   Db19 : constant String := """DOC"": ""Declare that a type, object, or component is atomic. See C.6."","
   & """_id"": ""7/3"","
   & """_name"": ""Atomic"","
   & """_origin"": ""Ada RM"","
   & """_category"": ""unknown"""
   ...
   & "},"
   & "{"
   & """DOC"": ""A condition that will hold true for all objects of a type. See"","
   & """_id"": ""63/3"","
   ...
   Db23 : constant String := """_name"": ""Elaborated"","
   & """_origin"": ""GNAT RM"","
   & """_category"": ""variable"""
   & "},"
   & "{"
   ...
   Db24 : constant String := """_origin"": ""GNAT RM"","
   & """_category"": ""variable"""
   & "},"
   & "{"
   ...
   Db25 : constant String := """_category"": ""variable"""
   & "},"
   & "{"
   ...
   Db28 : constant String := """DOC"": ""The `Safe_Small' attribute is provided for compatibility with Ada 83.\nSee the Ada 83 reference manual for an exact description of the\nsemantics of this attribute."","
   & """_id"": ""0"","
   & """_name"": ""Safe_Small"","
   & """_origin"": ""GNAT RM"","
   & """_category"": ""unknown"""
   ...
   Db30 : constant String := """_name"": ""Type_Key"","
   & """_origin"": ""GNAT RM"","
   & """_category"": ""unknown"""
   & "},"
   & "{"
   ...
   Db31 : constant String := """_origin"": ""GNAT RM"","
   & """_category"": ""variable"""
   & "},"
   & "{"
   ...
   Db32 : constant String := """_category"": ""variable"""
   & "},"
   & "{"
   ...
   Db37 : constant String := """_name"": ""Base"","
   & """_origin"": ""Ada RM"","
   & """_category"": ""type"""
   & "},"
   & "{"
   ...
   Db39 : constant String := """_category"": ""procedure"""
   & "},"
   & "{"
   & """DOC"": "", Initial_Value)\nFor a value_sequence V:\n\n\nThis attribute represents a reduction expression, and is in\nthe form of a reduction_attribute_reference. See 4.5.10."","
   & """_id"": ""198.1/5"","
   & """_name"": ""Reduce(Reducer"","
   & """_origin"": ""Ada RM"","
   & """_category"": ""variable"""
   & "},"
   & "{"
   ...
   Db45 : constant String := """_origin"": ""Ada RM"","
   & """_category"": ""variable"""
   & "},"
   & "{"
   ...
   Db46 : constant String := """_category"": ""function"""
   & "},"
   & "{"
   ...
   Db50 : constant String := """_id"": ""91.3/5"","
   & """_name"": ""Index"","
   & """_origin"": ""Ada RM"","
   & """_category"": ""variable"""
   & "},"
   ...
   & "},"
   & "{"
   & """DOC"": ""Syntax:\n\npragma Always_Terminates [ (boolean_EXPRESSION) ];\n\nFor the semantics of this pragma, see the entry for aspect\n`Always_Terminates' in the SPARK 2014 Reference Manual, section 6.1.11."","
   & """_id"": ""0"","
   & """_name"": ""Always_Terminates"","
   & """_origin"": ""GNAT RM"""
   & "},"
   ...
   Db53 : constant String := """_origin"": ""Ada RM"""
   & "},"
   & "{"
   & """DOC"": ""Syntax:\n\npragma Atomic;"","
   & """_id"": ""0"","
   ...
   Db56 : constant String := """_origin"": ""Ada RM"""
   & "},"
   & "{"
   ...
   & """_id"": ""0"","
   & """_name"": ""Interrupts_System_By_Default"","
   & """_origin"": ""GNAT RM"""
   & "},"
   & "{"
   ...
   & "},"
   & "{"
   & """DOC"": ""Syntax:\n\npragma Program_Exit [ (boolean_EXPRESSION) ];\n\nFor the semantics of this pragma, see the entry for aspect\n`Program_Exit' in the SPARK 2014 Reference Manual, section 6.1.10."","
   & """_id"": ""0"","
   & """_name"": ""Program_Exit"","
   & """_origin"": ""GNAT RM"""
   & "},"
   ...
   Db77 : constant String := """_origin"": ""GNAT RM"""
   & "},"
   & "{"
   ...
   Db81 : constant String := """_category"": ""function"""
   & "},"
   & "{"
   & """_name"": ""\""xor\"""","
   & """_category"": ""function"""
   ...
   Db82 : constant String := """_doc"": ""16#0A#"""
   & "},"
   & "{"
   & """_name"": ""VT"","
   & """_doc"": ""16#0B#"""
   ...
   Db84 : constant String := """_doc"": ""16#24#"""
   & "},"
   & "{"
   & """_name"": ""Percent"","
   & """_doc"": ""16#25#"""
   ...
   Db86 : constant String := """_doc"": ""16#6D#"""
   & "},"
   & "{"
   & """_name"": ""LC_N"","
   & """_doc"": ""16#6E#"""
   ...
   Db88 : constant String := """_category"": ""type"""
   & "},"
   & "{"
   & """_name"": ""Integer"","
   & """_category"": ""type"""
   ...
   & "},"
   & "{"
   & """_name"": ""Long_Long_Float"","
   & """_category"": ""type"""
   & "},"
   & "{"
   & """_name"": ""Long_Long_Integer"","
   & """_category"": ""type"""
   & "},"
   & "{"
   & """_name"": ""Natural"","
   ...
   & "},"
   & "{"
   & """_name"": ""Short_Short_Integer"","
   & """_category"": ""type"""
   & "},";

   Db89 : constant String := "{"
   & """_name"": ""Storage_Error"","
   & """_category"": ""variable"""
   & "},"
   & "{"
   ...
   & "},"
   & "{"
   & """_name"": ""Wide_Wide_Character"","
   & """_category"": ""type"""
   & "},"
   & "{"
   & """_name"": ""Wide_Wide_String"","
   & """_category"": ""type"""
   & "}"
   & "]"
   & "}"
   ...
   Db : constant String := Db1 & Db2 & Db3 & Db4 & Db5 & Db6 & Db7 & Db8 & Db9 & Db10 & Db11 & Db12 & Db13 & Db14 & Db15 & Db16 & Db17 & Db18 & Db19 & Db20 & Db21 & Db22 & Db23 & Db24 & Db25 & Db26 & Db27 & Db28 & Db29 & Db30 & Db31 & Db32 & Db33 & Db34 & Db35 & Db36 & Db37 & Db38 & Db39 & Db40 & Db41 & Db42 & Db43 & Db44 & Db45 & Db46 & Db47 & Db48 & Db49 & Db50 & Db51 & Db52 & Db53 & Db54 & Db55 & Db56 & Db57 & Db58 & Db59 & Db60 & Db61 & Db62 & Db63 & Db64 & Db65 & Db66 & Db67 & Db68 & Db69 & Db70 & Db71 & Db72 & Db73 & Db74 & Db75 & Db76 & Db77 & Db78 & Db79 & Db80 & Db81 & Db82 & Db83 & Db84 & Db85 & Db86 & Db87 & Db88 & Db89;

end LSP.Predefined_Completion.Ada2022;
