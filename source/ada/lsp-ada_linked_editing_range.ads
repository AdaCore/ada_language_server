...
--  This package provides handler and a job for textDocument/inkedEditingRange
--  requests.
...
package LSP.Ada_Linked_Editing_Range is

   type Ada_Linked_Editing_Range_Handler
