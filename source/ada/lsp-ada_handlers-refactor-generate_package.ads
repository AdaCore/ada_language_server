...
------------------------------------------------------------------------------
--
--  Implementation of the refactoring command to generate package body files

with VSS.Strings;
with LSP.Ada_Contexts;
with LSP.Server_Jobs;

package LSP.Ada_Handlers.Refactor.Generate_Package is

   type Command is new LSP.Ada_Handlers.Refactor.Command with private;

   overriding
   function Name (Self : Command) return String
   is ("Generate Package Body");
...
private
   ...
   for Command'External_Tag use "als-refactor-generate-package-body";
