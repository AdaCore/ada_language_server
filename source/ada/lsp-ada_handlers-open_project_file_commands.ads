...
------------------------------------------------------------------------------
--
--  Implementation of the command to open the current project file

with LSP.Ada_Commands;
with LSP.Errors;
with LSP.Server_Jobs;

package LSP.Ada_Handlers.Open_Project_File_Commands is
...
private
   ...
   for Command'External_Tag use "als-open-project-file";
