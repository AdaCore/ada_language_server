...
------------------------------------------------------------------------------
--
--  Implementation of the command to open the ALS GNATCOLL.Traces log file

with LSP.Ada_Commands;
with LSP.Errors;
with LSP.Server_Jobs;

package LSP.Ada_Handlers.Open_ALS_Log_File_Commands is
...
private
   ...
   for Command'External_Tag use "als-open-log-file";
