...
package body LSP.Ada_Documents is
   ...
   begin
      ...
      Lal_PP_Output.Trace
        ("Old_First_Line:" & Old_First_Line'Img &
           " Old_Length:" & Old_Length'Img &
           " New_First_Line:" & New_First_Line'Img &
           " New_Length:" & New_Length'Img);
            ...
            then
               ...
               then
                  ...
                  Prepare
                    (Old_Line_Number - 1,
                     UTF_16_Index
                       (Length (Old_Lines.Element
                        (Old_First_Line + Old_Index - 1))),
   ...
   begin
      Lal_PP_Output.Trace
        ("Span:" & Span.first.line'Img & Span.first.character'Img &
           Span.last.line'Img & Span.last.character'Img);
      ...
      Lal_PP_Output.Trace
        ("In_Range:" & In_Range.First'Img & In_Range.Last'Img);
      Lal_PP_Output.Trace
        (Input.Slice (In_Range.First, In_Range.Last));
      ...
      begin
         ...
         then
            ...
            Lal_PP_Output.Trace
              ("Out_Range:" & Out_Range.First'Img & Out_Range.Last'Img);
            ...
            Lal_PP_Output.Trace
              ("Out_Span:" & Out_Span.first.line'Img &
                 Out_Span.first.character'Img &
                 Out_Span.last.line'Img & Out_Span.last.character'Img);
