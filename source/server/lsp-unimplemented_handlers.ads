...
------------------------------------------------------------------------------
--
--  This package provides requests handler that tracks unimplemented requests.

with LSP.Server_Request_Receivers;
with LSP.Structures;

package LSP.Unimplemented_Handlers is

   type Unimplemented_Handler is limited
     new LSP.Server_Request_Receivers.Server_Request_Receiver
   with record
      Implemented : Boolean;
