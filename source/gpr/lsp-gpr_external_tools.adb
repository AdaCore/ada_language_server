...
package body LSP.GPR_External_Tools is
   ...
   procedure Import_GNATdoc3_Attributes;
   --  Register attributes used by GNATdoc3. They are registered for backward
   --  compatibility.
   ...
   begin
      ...
      Add_Attribute
        (Package_Name          => +"Documentation",
         Attribute_Name        => +"Documentation_Pattern",
         Index_Type            => PRA.No_Index,
         Value                 => Single,
         Value_Case_Sensitive  => True,
         Description           =>
           ...
           "the 'Documentation' package." & Ada.Characters.Latin_1.LF &
      ...
      Add_Attribute
        (Package_Name          => +"Documentation",
         Attribute_Name        => +"Excluded_Project_Files",
         Index_Type            => PRA.No_Index,
         Value                 => List,
         Value_Case_Sensitive  => True,
         Description           =>
           ...
           "package of the root project. " & Ada.Characters.Latin_1.LF &
           "This list may include any project files directly or indirectly " &
           "used by the root project.");

      --  Documentation.Image_Dirs

      Add_Attribute
        (Package_Name          => +"Documentation",
         Attribute_Name        => +"Image_Dirs",
         Description           =>
      ...
      --  Documentation.Resources_Dir

      Add_Attribute
        (Package_Name => +"Documentation",
         Attribute_Name => +"Resources_Dir",
         Index_Type            => PRA.String_Index,
         Value                 => Single,
         Value_Case_Sensitive  => True,
         Index_Optional        => True,
   ...
   --------------------------------
   -- Import_GNATdoc3_Attributes --
   --------------------------------

   procedure Import_GNATdoc3_Attributes is
   begin
      Add_Attribute
        (Package_Name          => +"Documentation",
      ...
      Add_Attribute
        (Package_Name          => +"Documentation",
         ...
         Value                 => Single,
         Value_Case_Sensitive  => True);
   end Import_GNATdoc3_Attributes;
